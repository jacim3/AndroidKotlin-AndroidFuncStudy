...
/*
    ...
    * ForegroundService : Notification(음악, 다운로드 등) 을 표시하는 등 사용자에게 잘 보이는 작업 수행
    -> 알림만 살아있으면, 서비스 유지
    * BackgroundService : 사용자에게 보이지 않는 작업을 수행. -> 어플리케이션 완전 종료 시, 서비스 소멸 (구버전 안드로이드 에선 서비스가 소멸하지 않음)
...
*/
    ...
    override fun onCreate() {
        super.onCreate()
        mediaPlayer = MediaPlayer.create(this, targetMusic)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notificationIntent = Intent(this, HandlerFragment::class.java)
   ...
   override fun onDestroy() {
    ...
    fun getTargetMusic (targetMusic:Int) {
